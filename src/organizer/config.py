...
def load_config(project_root: Path | None = None) -> AppConfig:
    ...
    return AppConfig(
        ...
        ai_batch_size=_parse_int("AI_BATCH_SIZE", 40, minimum=1),
        ai_concurrency=_parse_int("AI_CONCURRENCY", 2, minimum=1),
        ...
        telegram_scan_delay_seconds=_parse_float("TELEGRAM_SCAN_DELAY_SECONDS", 0.3, minimum=0.0),
